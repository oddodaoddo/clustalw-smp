...
void parse_params(Boolean xmenus)
{
	...
	if (!xmenus)
	{
		...
		fprintf(stdout, " SMP version 0.99-8 by Ognen Duzlevski, ognen@gene.pbi.nrc.ca\n");
		fprintf(stdout, " Plant Biotechnology Institute, National Research Council of Canada, Nov. 2001\n\n");
	}
